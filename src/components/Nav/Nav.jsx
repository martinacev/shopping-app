		...
		<>
			<nav className={classes.nav}>
				<div className={classes.wrapper}>
					...
					<ul>
						<li className={classes.category}>Collections</li>
						<li className={classes.category}>Men</li>
						<li className={classes.category}>Women</li>
						<li className={classes.category}>About</li>
						<li className={classes.category}>Contact</li>
					</ul>
				</div>

				<div className={classes.container}>
					<div className={classes.btnModal}>
						<button onClick={handleToggleModal} className={classes.basket}>
